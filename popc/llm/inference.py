...
class QwenPPCModel:
            ...
            with cls._lock:
                if cls._instance is None:
                    ...
                    if not os.path.exists(MODEL_PATH):
                        raise FileNotFoundError(f"Model path not found: {MODEL_PATH}. Make sure the Qwen model is downloaded and deployed.")
    ...
    def generate(prompt, max_tokens=120):
        ...
        if not result:
            raise ValueError("Model generated empty response. Check your prompt.")
